...
This document applies to all versions of NanaBox.
...
The build number is the number of days since April 1, 2022 because the first 
version of NanaBox is created and published on that day.
